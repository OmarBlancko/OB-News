      ...
      child: ClipRRect(
        ...
        child: Container(
            ...
            child: FadeInImage(
              ...
              imageErrorBuilder: (_, __, ___) => const CustomImagePlaceHolder(),
...
Image.network(
            ...
            errorBuilder: (_, __, ___) {
              return  const CustomImagePlaceHolder();
            },
          ),
 */
  Widget _buildTitleAndDescription() {
    final word = DateFormat("yyyy-MM-dd   HH:MM").format(DateTime.parse(article.publishedAt??""));
  ...
  void _onTap() {
    // context.goNamed(ArticleDetailsView.routeName,extra: article);
